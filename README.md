...
- Joshua Lacatan – Team Lead / Project Lead
- Grace C. Cabanatan – Documentation Lead
- Jericho Fernandez – Diagram Designer
...
1. Enhance system safety and security by implementing PIN-based authentication, tilt detection sensors with automatic shutdown, and an emergency stop feature.
2. Improve navigation and operational efficiency using GPS-based mapping and intelligent path planning.
...
- Out-of-scope for now:
  ...
  - Smart self-learning navigation
  - Operation in large areas
...
- Languages/Frameworks: React, Firebase, JavaScript
- Integration approach: REST APIs, Webhooks, IoT messaging
- Repos/Services: GitHub, GitHub Actions
- Testing tools: Jest, Postman, manual testing
...
- Clone: `git clone https://github.com/gracecabanatan14-bit/ITE412_SIA2_TeamEcoMow_EcoMowProject.git`
- Default branch: `main`
